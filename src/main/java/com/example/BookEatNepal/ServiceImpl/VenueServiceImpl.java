...
public class VenueServiceImpl implements VenueService {
    ...
    @Override
    public VenueDTO findAvailableVenues(String venueName, String checkAvailableDate, int numberOfGuests, String location, int minCapacity, int maxCapacity, double minPrice, double maxPrice,double rating, int page, int size) {
        ...
        if (checkAvailableDate != null && !checkAvailableDate.isEmpty()) {
            ...
            Subquery<Long> hallAvailabilitySubquery = cq.subquery(Long.class);
            ...
            hallAvailabilitySubquery.select(hallJoin.get("venue").get("id"))
                    .where(
